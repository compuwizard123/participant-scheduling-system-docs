...
\begin{table}[!h]\footnotesize
    \begin{tabular}{|p{2.5cm}|c|c|p{1.25cm}|p{1cm}|p{1.25cm}|p{1cm}|p{3.75cm}|}
        ...
        \hline
        Levels of Authentication & Approved & Useful & Medium & High & Medium & 3rd & Have levels of administers, workers and participants in order to control privacy issues and other sensitive data \\
        \hline
        ...
        \hline
        Remove Experiments & Approved & Important & Low & Low & High & 4th & Allow for workers or administers to remove schedules \\
        \hline
        ...
        \hline
        Prevent Scheduling Conflicts (Administer) & Rejected & Useful & High & Low & Medium & N/A & Prevent 2 rooms from being scheduled at the same time \\
        \hline
